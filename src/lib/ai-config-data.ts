...
export const sampleQrCodes = [
    { id: 'qr_123', name: 'QR Code for Eco Bottle' },
    { id: 'qr_456', name: 'QR Code for Charging Pad' },
    { id: 'qr_789', name: 'QR Code for Tote Bag' },
];

export const sampleProducts = [
    { id: 'prod_1', name: 'Eco-Friendly Water Bottle', category: 'Lifestyle' },
    { id: 'prod_2', name: 'Wireless Charging Pad', category: 'Electronics' },
];

export const sampleConversation = [
    { role: 'assistant', content: 'Hi there! How can I help you with the Eco-Friendly Water Bottle today?' },
    { role: 'user', content: 'Is it dishwasher safe?' },
    { role: 'assistant', content: 'Great question! Yes, it is top-rack dishwasher safe for easy cleaning.' },
];
