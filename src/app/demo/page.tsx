...
import { PlayCircle, Mic, Milestone, PauseCircle, FastForward, ArrowLeft } from 'lucide-react';
    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12">
            ...
            <div className="space-y-8">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight mb-2">Retailer MVP Demo</h2>
