...
const DEMO_PRODUCTS = [
  {
    ...
    description: 'Our flagship red. Bold, complex, and aged for 18 months in French oak. Notes of dark chocolate and roasted coffee.',
    category: 'Red Wine',
    price: 350.00,
  ...
  },
  {
    ...
    brand: 'Heritage Vineyards',
    description: 'A refreshing, crisp blend perfect for summer afternoons. Zesty citrus notes with a smooth mineral finish.',
    category: 'White Wine',
    price: 185.00,
  ...
  },
  {
    ...
    name: 'Vintage Brut',
    brand: 'Heritage Vineyards',
    description: 'Elegant bubbles for special celebrations. Traditional method sparkling wine with toasted brioche aromas.',
    category: 'Sparkling',
    price: 450.00,
  ...
  },
  {
    ...
    brand: 'Heritage Vineyards',
    description: 'A deep, structured Cabernet with intense blackcurrant flavors and refined tannins. Ideal for long-term cellaring.',
    category: 'Red Wine',
    price: 580.00,
