        ...
        <div className="space-y-8">
            <div>
                <h2 className="text-2xl font-bold tracking-tight mb-2">
                    UI/UX Development & Simulation
                </h2>
                <p className="text-muted-foreground max-w-3xl">
                    Design, test, and visualize the end-to-end mobile experience for your customers.
                </p>
            </div>
            <Separator />
                ...
                <div className="lg:col-span-2 space-y-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Create scannable QR codes for your product URLs to test the customer journey. Use your phone's camera to scan the generated code.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    {generatedCodes.length > 0 && (
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    A list of all QR codes you have generated in this session.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Table>
