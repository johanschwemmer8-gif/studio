...
export default function CrmConfigurationPage() {
  ...
  const handleSaveChanges = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      ...
      description: 'Your Loyalty/CRM configuration has been updated.',
    });
  };
  ...
  const handleTestConnection = () => {
    toast({
      ...
      description: 'Successfully connected to the Loyalty/CRM system.',
    });
  };
    ...
    <div className="space-y-8">
       <div>
        ...
        <p className="text-muted-foreground max-w-3xl">
          Connect your Customer Relationship Management or Loyalty program to enrich customer profiles and personalize offers.
        </p>
      </div>
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    ...
                    <Input id="api-endpoint" placeholder="https://api.your-crm.com/v1/" />
                </div>
                 <div className="space-y-2">
