...
import { Save, TestTube2, Database } from 'lucide-react';
    ...
    <div className="space-y-8">
       <div>
        ...
        <p className="text-muted-foreground max-w-3xl text-sm mt-2">
          Connect iNteract to your Enterprise Resource Planning system for live stock, pricing, and product data across the network.
        </p>
      </div>
        ...
        <Card className="border-primary/10 shadow-lg">
            <CardHeader className="bg-muted/30 border-b">
                ...
                <CardDescription className="text-xs">
                    Provide the production API details for your global ERP system.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6 pt-6">
                <div className="space-y-2">
                    ...
                    <Input id="api-endpoint" placeholder="https://api.your-erp.com/v1/" className="h-11 font-mono" />
                </div>
